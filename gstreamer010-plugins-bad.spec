...
Provides:	gstreamer-plugins-bad = %{version}-%{release}
Obsoletes:	gstreamer-plugins-bad < %{version}-%{release}
...
Group:		Libraries
Provides:	gstreamer-plugins-bad-libs = %{version}-%{release}
Obsoletes:	gstreamer-plugins-bad-libs < %{version}-%{release}
...
Provides:	gstreamer-plugins-bad-apidocs = %{version}-%{release}
Obsoletes:	gstreamer-plugins-bad-apidocs < %{version}-%{release}
